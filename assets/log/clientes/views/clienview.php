...
class ClienView{
    ...
    public function index(){
        $pagina = file_get_contents('assets/log/public_html/login.html');
    ...
    public function cliente(){
        $pagina = file_get_contents('assets/log/public_html/cliente.html');
        print($pagina);
    }
    public function mensaje($mensaje){
        
        $pagina = file_get_contents('assets/log/public_html/template2.html');
        $paginaf = str_replace('{MENSAJE}',$mensaje,$pagina);
        print($paginaf);
    }
     public function lista($datos){
        $pagina=file_get_contents('assets/log/public_html/listac.php');
    ...
    public function seleccion($clientes){
        $pagina=file_get_contents('seleccion.php');
...
public function updatec($id){
        $pagina=file_get_contents('assets/log/public_html/updatecliente.php'); 
